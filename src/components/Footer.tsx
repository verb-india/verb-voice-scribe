...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-br from-black via-black to-[#1a0f00] py-16">
      {/* Centered divider line */}
      <div className="flex justify-center mb-12">
        <div className="h-px bg-orange-500/20 w-1/2"></div>
      </div>
      ...
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center gap-4">
            <button className="bg-gradient-to-r from-orange-600 to-yellow-600 hover:from-orange-700 hover:to-yellow-700 text-white font-medium px-8 py-3 rounded-full transition-all duration-300 shadow-[0_0_15px_rgba(255,165,0,0.2)]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8 mb-12">
          <div>
            <div className="flex items-center mb-6">
              <div className="scale-x-110">
                <img src="/logo.png" alt="Verb Logo" className="w-8 h-8 mr-2 drop-shadow-[0_0_10px_rgba(255,165,0,0.3)]" />
              </div>
              <span className="text-2xl font-bold text-white">Verb</span>
            </div>
          ...
          <div>
            <ul className="space-y-3 text-sm">
              ...
              <li>
                <Link to="/manifesto" className="text-gray-300 hover:text-orange-400 transition-colors">
                  Manifesto
                </Link>
              </li>
              <li>
                <Link to="/pricing" className="text-gray-300 hover:text-orange-400 transition-colors">
                  Pricing
                </Link>
              </li>
              <li>
